...
def doctor(args):
    ...
    for pkg in ['scikit-learn', 'numpy', 'imbalanced-learn', 'optuna', 'catboost', 'tensorflow', 'matplotlib', 'scipy']:
        try:
            mod = __import__(pkg.replace('-', '_').replace('imbalanced_learn', 'imblearn'))
